...
export function EvidenceSheet({ evidence, onClose }: { evidence: Evidence | null; onClose: () => void }) {
  ...
  return (
    <>
      ...
      <div
        className="el-overlay-panel el-evidence-sheet"
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: S[2] }}>
          ...
          <button aria-label="Close evidence" onClick={onClose} style={{ marginLeft: "auto", background: "none", border: "none", color: C.muted, fontSize: T.lg }}>
