  ...
  return (
    ...
    >
      ...
      <div className="el-screen-heading" style={{ minWidth: 0 }}>
        ...
        >
          {title}
          {product ? <span className="el-screen-product" style={{ color: C.dim, fontWeight: 400 }}>{product}</span> : null}
        </h1>
        {subtitle && (
          <div
            style={{
      ...
      <div className="el-screen-header__spacer" style={{ flex: 1, minWidth: S[4] }} />
      {right}
    </header>
  );
}
