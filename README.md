...
- **Deploy**: backend on Render + frontend on Vercel + Supabase DB (see [DEPLOY.md](DEPLOY.md)), or all-in-one `docker compose up` (Postgres, Redis, backend, frontend, Nginx) for a VPS.
